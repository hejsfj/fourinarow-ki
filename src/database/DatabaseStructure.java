...
class DatabaseStructure {
	...
	String createTableSatz = "CREATE TABLE IF NOT EXISTS satz ( spiel_id INTEGER, satz_nr INTEGER, spieleoxpunkte INTEGER, spielerxpunkte INTEGER, startspieler VARCHAR(256), PRIMARY KEY(spiel_id, satz_nr))";
